													...
													<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="text-align: center; width: 100%;" role="grid" aria-describedby="dataTable_info">
														...
														<tfoot>
															<tr>
																...
																<th rowspan="1" colspan="1"><button type="button" onclick="memberSave(mName);" class="btns">저 장</button></th>
															</tr>
														</tfoot>
														<tbody>
															...
															<tr>
																...
																<td><input style="border: white;" type="text" name="mId" id="mId" readonly="readonly" value="${member.mId }"></td>
																...
																<td><input type="text" name="mMileage" id="mMileage" value="${member.mMileage }"></td>
																<td>
...
<!--         <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" crossorigin="anonymous"></script>
	...
	<!-- 	<script type="text/javascript">
		...
		<script type="text/javascript">
		function memberSave(mId,mName,mPhone,mEmail,mMileage) {
			memberForm.action = "${pageContext.request.contextPath}/admin/modify;";
			memberForm.submit();
		}
