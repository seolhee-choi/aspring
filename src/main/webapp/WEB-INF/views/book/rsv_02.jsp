		...
		<c:forEach var="room" items="${roomList }">
			...
			<div class="col-md-6">
					<div class="easy-block-book">
						...
						<img alt="" src="${pageContext.request.contextPath }/assets/img/aspring/room${room.rmNo}/aspring_room${room.rmNo}_main.jpg">
						...
						<div class="carousel slide carousel-v1" id="myCarousel${room.rmNo}">
							...
							<div class="row text-center margin-bottom-30">
								...
								<form action="${pageContext.request.contextPath}/rsv/stepThree" method="post">
									...
									<a class="btn-u btn-brd rounded btn-u-green" href="${pageContext.request.contextPath}/roomtest${room.rmNo}">
