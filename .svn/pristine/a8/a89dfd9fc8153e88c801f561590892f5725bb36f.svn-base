...
<body>
	...
	<div id="board_write" class="wrap">
		<h2 class="board_write_title">
			<span class="board_write_title_bar"></span>리뷰 상세
		</h2>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tbody>
								<tr>
									...
									<td width="1070" height="55" align="left" valign="middle">
										<input type="text" id="rvTitle" readonly="readonly" name="rvTitle" value="${rvNo.rvTitle }" style="width: 1020px;">
									</td>
								</tr>
							</tbody>
						</table>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tbody>
								<tr>
									...
									<td width="1070" height="55" align="left" valign="middle">
										<input type="text" id="rvHits" name="rvHits" value="${rvNo.rvHits }" readonly="readonly" style="width: 1020px;">
									</td>
								</tr>
							</tbody>
						</table>
				...
				<tr>
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tbody>
								<tr>
									<td width="130" height="400" align="center" valign="middle"
									...
									<td width="1070" height="400" align="left" valign="top"
										...
										<br><textarea class="board_write_txt" name="rvContent" id="rvContent" readonly="readonly">${rvNo.rvContent }</textarea>
									</td>
								</tr>
							</tbody>
						</table>
				...
				<tr>
					<td>
						<div class="board_write_bt" style="height: 55px;">
							<div class="button-1">
								<div class="eff-1"></div>
								<a href="${pageContext.request.contextPath }/review/modify/${rvNo.rvNo}" style="color: black;" >리뷰수정하기</a>
							</div>
							
							<div class="button-1">
								<div class="eff-1"></div>
								<a href="${pageContext.request.contextPath }/review" style="color: black;">목록으로 </a>
							</div>
						</div>
					</td>
				</tr>
